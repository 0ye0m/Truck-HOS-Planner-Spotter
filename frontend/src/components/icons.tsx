/**
 * Inline SVG icon set (Lucide-style, 24×24 stroke icons).
 * Keeps the UI professional and consistent — no emoji glyphs anywhere.
 */
...
export const FuelIcon = make(
  <>
    <line x1="3" x2="3" y1="22" y2="4" />
    <path d="M3 6h6v6H3z" />
    <path d="M9 8h2a2 2 0 0 1 2 2v6a2 2 0 0 0 2 2h1a2 2 0 0 0 2-2v-5l-2-2" />
    <path d="M16 6.5 18 8" />
    <line x1="3" x2="12" y1="22" y2="22" />
  </>
);
...
/** Small "?" hint chip with a native tooltip — used across the UI. */
export function InfoHint({ text, label }: { text: string; label?: string }) {
  return (
    <span
      ...
      title={text}
      className="inline-flex h-4 w-4 cursor-help items-center justify-center rounded-full text-slate-400 hover:text-slate-600 focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-500"
    >
      <InfoIcon size={13} />
    </span>
  );
